 ...
 */
export declare function checkShapeDataFields(dataSource: object[], properties: object, dataPath: string, propertyPath: string): number;
 ...
 */
export declare function findMidPointOfPolygon(points: MapLocation[]): object;
/**
 * @private
 * Check custom path
 */
...
/** @private */
export declare function calculateLegendShapes(location: Point, size: Size, shape: string, options: PathOption, url: string): IShapes;
/**
 * Animation Effect Calculation End
 * @private
 */
