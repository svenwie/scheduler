...
export declare class TablePropertiesDialog {
     ...
     * @private
     */
    initTablePropertyDialog(localValue: L10n): void;
    /**
     * @private
     */
    show(): void;
     ...
     * @private
     */
    initTableProperties(element: HTMLDivElement, localValue: L10n): void;
    /**
     * @private
     */
     ...
     * @private
     */
    initTableRowProperties(element: HTMLDivElement, localValue: L10n): void;
     ...
     * @private
     */
    initTableCellProperties(element: HTMLDivElement, localValue: L10n): void;
