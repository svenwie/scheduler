...
export declare class PageSetupDialog {
     ...
     * @private
     */
    initPageSetupDialog(locale: L10n): void;
    /**
     * @private
     */
    initMarginProperties(element: HTMLDivElement, locale: L10n): void;
    /**
     * @private
     */
    initPaperSizeProperties(element: HTMLDivElement, locale: L10n): void;
    /**
     * @private
     */
    initLayoutProperties(element: HTMLDivElement, locale: L10n): void;
    /**
     * @private
     */
    show(): void;
