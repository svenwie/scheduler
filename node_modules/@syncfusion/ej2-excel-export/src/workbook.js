define(["require", "exports", "./worksheets", "./worksheet", "./cell-style", "./column", "./row", "./cell", "@syncfusion/ej2-compression", "./csv-helper", "@syncfusion/ej2-base", "./blob-helper"], function (require, exports, worksheets_1, worksheet_1, cell_style_1, column_1, row_1, cell_1, ej2_compression_1, csv_helper_1, ej2_base_1, blob_helper_1) {
    "use strict";
    ...
    var Workbook = (function () {
        function Workbook(json, saveType, culture, currencyString) {
            ...
            this.intl = new ej2_base_1.Internationalization(this.culture);
            ...
            if (saveType === 'xlsx') {
                ...
                this.mFills = new Map();
                this.mStyles.push(new cell_style_1.CellStyle());
                this.mFonts.push(new cell_style_1.Font());
                this.cellStyles.set('Normal', new cell_style_1.CellStyles());
                this.mCellXfs = [];
                this.mCellStyleXfs = [];
                    ...
                    for (var i = 0; i < json.styles.length; i++) {
                        if (json.styles[i].name !== undefined) {
                            if (!this.cellStyles.has(json.styles[i].name)) {
                                var cellStyle = new cell_style_1.CellStyle();
                                cellStyle.isGlobalStyle = true;
                                this.parserCellStyle(json.styles[i], cellStyle, 'none');
                                var cellStylesIn = new cell_style_1.CellStyles();
                ...
                this.csvHelper = new csv_helper_1.CsvHelper(json);
            }
        }
        ...
        Workbook.prototype.parserWorksheets = function (json) {
            this.worksheets = new worksheets_1.Worksheets();
            var length = json.length;
            for (var i = 0; i < length; i++) {
                var jsonSheet = json[i];
                var sheet = new worksheet_1.Worksheet();
                this.mergeCells = new worksheet_1.MergeCells();
        ...
        Workbook.prototype.parserFreezePanes = function (json, sheet) {
            sheet.freezePanes = new worksheet_1.FreezePane();
            ...
            if (this.mergeCells.length > 0) {
                this.mergedCellsStyle.forEach(function (value, key) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(row)) {
                        ...
                        var rowToInsert = new row_1.Row();
                        rowToInsert.index = value.y;
                        rowToInsert.cells = new cell_1.Cells();
        ...
        Workbook.prototype.createCell = function (value, key) {
            var cellToInsert = new cell_1.Cell();
            cellToInsert.refName = key;
            cellToInsert.index = value.x;
            cellToInsert.cellStyle = new cell_style_1.CellStyle();
        ...
        Workbook.prototype.parseGrouping = function (json, row) {
            row.grouping = new worksheet_1.Grouping();
        ...
        Workbook.prototype.parseCells = function (json, row) {
            ...
            for (var cellId = 0; cellId < cellsLength; cellId++) {
                ...
                if (jsonCell.hyperlink !== null && jsonCell.hyperlink !== undefined) {
                    var hyperLink = new worksheet_1.HyperLink();
                    if (jsonCell.hyperlink.target !== undefined) {
                        ...
                        cell.cellStyle = new cell_style_1.CellStyle();
        ...
        Workbook.prototype.parserCellStyle = function (json, cellStyle, cellType, defStyleIndex) {
            ...
            cellStyle.borders = new cell_style_1.Borders();
        ...
        Workbook.prototype.processNumFormatId = function (style) {
            if (style.numberFormat !== 'GENERAL' && !this.mNumFmt.has(style.numberFormat)) {
                ...
                this.mNumFmt.set(style.numberFormat, new cell_style_1.NumFmt(id, style.numberFormat));
            }
        };
        ...
        Workbook.prototype.isNewBorder = function (toCompareStyle) {
            var bStyle = new cell_style_1.CellStyle();
        ...
        Workbook.prototype.isAllBorder = function (toCompareBorder) {
            var allBorderStyle = new cell_style_1.CellStyle();
        ...
        Workbook.prototype.saveWorksheet = function (sheet, index) {
            var sheetBlob = new blob_helper_1.BlobHelper();
            ...
            if (sheet.rows !== undefined) {
                for (var _b = 0, _c = sheet.rows; _b < _c.length; _b++) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(row.spans)) {
        ...
        Workbook.prototype.updateCellXfsStyleXfs = function () {
            for (var _i = 0, _a = this.mStyles; _i < _a.length; _i++) {
                ...
                if (style.isGlobalStyle) {
                    cellXfs = new cell_style_1.CellStyleXfs();
                    cellXfs.xfId = (style.index - 1);
                }
                else {
                    cellXfs = new cell_style_1.CellXfs();
                    cellXfs.xfId = 0;
                }
                var compareFontResult = this.isNewFont(style);
                if (!compareFontResult.result) {
                    var font = new cell_style_1.Font();
                    font.b = style.bold;
                    font.i = style.italic;
                ...
                cellXfs.alignment = new cell_style_1.Alignment();
        ...
        Workbook.prototype.addToArchive = function (xmlString, itemName) {
            if (typeof (xmlString) === 'string') {
                ...
                var archiveItem = new ej2_compression_1.ZipArchiveItem(blob, itemName);
                this.mArchive.addItem(archiveItem);
            }
            else {
                var archiveItem = new ej2_compression_1.ZipArchiveItem(xmlString, itemName);
                this.mArchive.addItem(archiveItem);
            }
        };
        Workbook.prototype.processMergeCells = function (cell, rowIndex, mergeCells) {
            if (cell.rowSpan !== 0 || cell.colSpan !== 0) {
                var mCell = new worksheet_1.MergeCell();
                mCell.x = cell.index;
