...
$hscroll-device-arrow-bg: $grey-50;
$hscroll-device-arrow-border-size: 1px;
$hscroll-device-arrow-border-color: rgba($grey-black, .12);
$hscroll-device-arrow-color: $accent;
$hscroll-device-arrow-size: 14px;
$hscroll-device-arrow-width: 56px;
