import { SvgRenderer, BaseAttibutes } from '@syncfusion/ej2-base';
import { Effect } from '@syncfusion/ej2-base';
import { PathAttributes, RectAttributes, CircleAttributes } from '@syncfusion/ej2-base';
 ...
 */
export declare function pathAnimation(element: Element, direction: string, redraw: boolean, previousDirection?: string): void;
/**
...
/** @private */
export declare function findDirection(rX: number, rY: number, rect: Rect, arrowLocation: ChartLocation, arrowPadding: number, top: boolean, bottom: boolean, left: boolean, tipX: number, tipY: number, tipRadius?: number): string;
/** @private */
export declare function redrawElement(redraw: boolean, id: string, options?: PathAttributes | RectAttributes | CircleAttributes, renderer?: SvgRenderer): Element;
/** @private */
